...
const switcher=(language,ruPath,enPath)=>`<nav class="language-switcher" aria-label="${labels[language].language}"><a href="${ruPath}" data-language="ru" lang="ru"${language==='ru'?' aria-current="true"':''}>RU</a><a href="${enPath}" data-language="en" lang="en"${language==='en'?' aria-current="true"':''}>EN</a></nav>`;
